...
namespace BetterUI
{
    ...
    public class Main : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            ...
            showCustomTooltips = Config.Bind("2 - Character Inventory", nameof(showCustomTooltips), false, "Show more info on inventory item tooltips. Disable this is using Epic Loot.");
            ...
            enemyLvlStyle = Config.Bind("6 - Enemy HUD", nameof(enemyLvlStyle), 2, "Choose how enemy lvl is shown. 0 = Default(stars) | 1 = Prefix before name (Lv. 1) | 2 = Both");
