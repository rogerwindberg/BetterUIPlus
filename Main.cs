...
namespace BetterUI
{
    ...
    public class Main : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            ...
            showCustomTooltips = Config.Bind(sectionName, nameof(showCustomTooltips), false, "Show more info on inventory item tooltips. Disable this if using Epic Loot.");
            ...
            var enemyLevelStyleDefault = GetOldOrDefaultConfigValue(new ConfigDefinition(sectionName, "enemyLvlStyle"), 2);
